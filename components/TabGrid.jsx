		...
		<>
			...
			>
				<motion.div
					...
					className="w-full box-border p-4 lg:p-8 bg-primary-100 rounded-xl lg:rounded-2xl shadow-md text-primary-900 transition-colors duration-300"
				>
					<div className="w-full bg-primary-200 rounded-lg lg:rounded-xl">
						{tabs.map((tab, index) => {
							return (
								<div key={index}>
									<div className="p-4 lg:p-8 grid grid-cols-1 lg:grid-cols-7 gap-4 lg:gap-8 xl:gap-12">
										<div
											key={index} 
