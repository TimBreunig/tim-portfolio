...
const Home = () => {
	return (
		<div>
			...
			<section className="h-[50vh] lg:min-h-svh box-content lg:pb-60">
				<HeadingFullPage />
			</section>

			<section className="relative lg:min-h-svh box-content py-24 lg:py-18 flex items-center bg-primary-100 z-10">
				<TechStack />
			</section>
